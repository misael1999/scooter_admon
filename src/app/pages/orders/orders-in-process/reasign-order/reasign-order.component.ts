...
@Component({
  selector: 'app-reasign-order',
  templateUrl: './reasign-order.component.html',
  styleUrls: ['./reasign-order.component.scss']
})
export class ReasignOrderComponent implements OnInit {
  ...
  assignDeliveryToOrder() {
    ...
    this.orderService.reassignDeliveryToOrder(this.orderId, { delivery_man_id: this.selectedDelivery })
      .subscribe((data: any) => {
